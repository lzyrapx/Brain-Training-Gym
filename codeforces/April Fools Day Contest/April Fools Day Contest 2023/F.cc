...
class BigInt {
 ...
 public:
     ...
     ll toll() { return stoll(this->to_string()); }
     int toi() { return stoi(this->to_string()); }
     BigInt() : num("0"), sign("+") {}
     BigInt(const int t) {
         if (t < 0) {
...
void solve() {
    ...
    cin >> s;
    BigInt n(s);
    BigInt a("991999999999");
    BigInt b("");
    if (n % a == 0) {
        cout << n / a << "\n";
    }
    if (n % b == 0) {
